...
[Download Builds](https://eamonnmr.itch.io/galactic-night)

![Screenshot](https://github.com/EamonnMR/galactic-night/blob/main/screenshots/scout.jpg)
...
**E** - Interact with selected station/planet
...
Gather materials, use metal to build a space station, click to select it then press E to interact with it. Press M to open the map, click to select another system, fly out and press J to hyperspace to it.
